  ...
  return (
    <div className="bg-white p-6 rounded-2xl shadow-lg max-w-2xl mx-auto">
      <div className="mb-4">
        ...
        <input value={village} onChange={e=>setVillage(e.target.value)} placeholder="e.g., Sadiya" className="mt-1 w-full border rounded px-3 py-2" />
      </div>
      ...
      <div className="mb-6">
        ...
        <select value={water} onChange={e=>setWater(e.target.value)} className="mt-1 w-full border rounded px-3 py-2">
      ...
      <div className="flex justify-between items-center">
        <button onClick={() => { if(!village){alert('Add village');return;} onSubmit({ village, symptoms, water }); }}
